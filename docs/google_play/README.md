# Materiały Google Play — NapStack
...
**Uwaga:** Zrzuty ekranu w konsoli powinny ostatecznie pochodzić z **działającej aplikacji** na urządzeniu — grafiki w `store_graphics` to baza marketingowa / szablon.
